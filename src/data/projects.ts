...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Live dual-layer environmental dashboard for Greece. Tracks real-time seismic activity from the USGS earthquake feed and current weather conditions across 15 cities via Open-Meteo API. Toggle between layers, click markers for detailed readings, and monitor summary statistics updated on every load.",
    tags: ["Leaflet", "React", "Typescript", "REST API"],
    highlight: false,
  ...
  },
  {
    ...
    tags: ["Leaflet", "TypeScript", "Overpass API", "MarkerCluster", "OSM"],
    highlight: false,
