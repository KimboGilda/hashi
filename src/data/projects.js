export const projects = [
    {
        ...
        description: "Interactive choropleth map visualizing population density across all 26 Swiss cantons. Built with React, Leaflet and open Swiss federal geodata.",
    ...
    },
    {
        ...
        description: "Live dual-layer environmental dashboard for Greece. Tracks real-time seismic activity from the USGS earthquake feed and current weather conditions across 15 cities via Open-Meteo API.",
